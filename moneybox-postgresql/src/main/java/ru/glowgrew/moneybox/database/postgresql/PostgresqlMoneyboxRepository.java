...
public class PostgresqlMoneyboxRepository implements MoneyboxRepository {
    ...
    public PostgresqlMoneyboxRepository(ConnectionPool connectionPool, MoneyboxConfiguration configuration) {
